...
_arguments -s \
    '(-l --list)'{-l,--list}'[List common crypto currencies]' \
    '(-u --usage)'{-u,--usage}'[More detailed help]' \
    '(-p --price)'{-p,--price}'[Get current price(s)]' \
    '(-c --convert)'{-c,--convert}'[Convert crypto currency(abreviate: usd/btc/etc)]' \
